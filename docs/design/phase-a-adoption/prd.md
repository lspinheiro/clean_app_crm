...
| The delivered M1 surface — one rotating invite code, `join_company_pool`, and the shipped Staff screen — must migrate to postings. What happens to a live shared link at cutover? | Leonardo | Open — for the milestone and LLD reconciliation (CLE-59–62) |
