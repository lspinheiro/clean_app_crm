...
the account one of the company's [cleaners](#cleaners) and is created through a cleaner
invite link. One account can hold many memberships, of both kinds, across companies — the
