...
openwiki:
  ...
  symbols: [requireCompanyAdmin, proxy, routing, createOneOffJob, assignJobSlot, cancelJob, createPosting, offerJob, revalidateLocalizedPath]
